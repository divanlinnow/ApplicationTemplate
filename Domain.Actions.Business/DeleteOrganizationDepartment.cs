...
{
    public sealed class DeleteOrganizationDepartment<T> : BasicAction<T> where T : class
    {
        public DeleteOrganizationDepartment(IServiceProviderBusiness serviceProvider) : base(serviceProvider)
        {
        }
