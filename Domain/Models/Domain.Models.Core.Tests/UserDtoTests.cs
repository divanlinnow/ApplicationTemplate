...
namespace Domain.Models.Core.Tests
{
    ...
    public class UserDtoTests
    {
        ...
        public void User_Property_Language()
        {
            // Arrange
            var user = new UserDto();
            var value = TestHelper.LanguageDto();
            ...
            Assert.IsInstanceOfType(user.Language, typeof(LanguageDto));
        ...
        public void User_Property_Roles()
        {
            ...
            Assert.IsInstanceOfType(user.Roles, typeof(List<RoleDto>));
        ...
        public void User_Property_Emails()
        {
            // Arrange
            var user = new UserDto();
            var value = TestHelper.EmailDtos();
            ...
            Assert.IsInstanceOfType(user.Emails, typeof(List<EmailDto>));
        ...
        public void User_Property_PhoneNumbers()
        {
            // Arrange
            var user = new UserDto();
            var value = TestHelper.PhoneNumberDtos();
            ...
            Assert.IsInstanceOfType(user.PhoneNumbers, typeof(List<PhoneNumberDto>));
        ...
        public void User_Property_Addresses()
        {
            // Arrange
            var user = new UserDto();
            var value = TestHelper.AddressDtos();
            ...
            Assert.IsInstanceOfType(user.Addresses, typeof(List<AddressDto>));
        ...
        public void User_Property_CreatedBy()
        {
            ...
            Assert.IsInstanceOfType(user.CreatedBy, typeof(UserDto));
        ...
        public void User_Property_ModifiedBy()
        {
            ...
            Assert.IsInstanceOfType(user.ModifiedBy, typeof(UserDto));
        ...
        public void User_Extension_AsEntity_Null()
        {
            // Arrange
            UserDto user = null;

            // Act
            var result = user.AsEntity();
        ...
        [TestMethod]
        [TestCategory("Models - Extensions")]
        public void User_Extension_AsEntity_NotNull()
        {
            // Arrange
            var user = TestHelper.UserDto();
            ...
            Assert.IsInstanceOfType(result.Language, typeof(Language));

            Assert.IsNotNull(result.Roles);
            Assert.IsInstanceOfType(result.Roles, typeof(List<Role>));

            Assert.IsNotNull(result.Emails);
            Assert.IsInstanceOfType(result.Emails, typeof(List<Email>));

            Assert.IsNotNull(result.PhoneNumbers);
            Assert.IsInstanceOfType(result.PhoneNumbers, typeof(List<PhoneNumber>));

            Assert.IsNotNull(result.Addresses);
            Assert.IsInstanceOfType(result.Addresses, typeof(List<Address>));
