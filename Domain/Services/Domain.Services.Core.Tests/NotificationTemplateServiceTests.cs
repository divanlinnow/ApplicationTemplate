...
namespace Domain.Services.Core.Tests
{
    ...
    public class NotificationTemplateServiceTests
    {
        ...
        public void FindNotificationTemplateById_Service_Success()
        {
            // Arrange
            notificationTemplateService = new NotificationTemplateService(mockRepository.Object, mockLogger.Object, mockCache.Object, mockTelemetry.Object);
            mockRepository.Setup(x => x.FindById<NotificationTemplate>(Guid.Empty)).Returns(new NotificationTemplate()).Verifiable();

            // Act
            var response = notificationTemplateService.FindNotificationTemplateById(Guid.Empty);

            // Assert
            Assert.IsNotNull(response);
            Assert.IsNotNull(response.Result);
            Assert.IsInstanceOfType(response, typeof(GenericServiceResponse<NotificationTemplateDto>));
            mockRepository.Verify(x => x.FindById<NotificationTemplate>(Guid.Empty), Times.Once);
        }
        ...
        public void FindNotificationTemplateById_Service_Fail()
        {
            // Arrange
            notificationTemplateService = new NotificationTemplateService(mockRepository.Object, mockLogger.Object, mockCache.Object, mockTelemetry.Object);
            mockRepository.Setup(x => x.FindById<NotificationTemplate>(Guid.Empty)).Throws(new Exception()).Verifiable();
        ...
        public void DeleteNotificationTemplateById_Service_Success()
        {
            // Arrange
            notificationTemplateService = new NotificationTemplateService(mockRepository.Object, mockLogger.Object, mockCache.Object, mockTelemetry.Object);
            mockRepository.Setup(x => x.Delete<NotificationTemplate>(Guid.Empty)).Returns(true).Verifiable();

            // Act
            var response = notificationTemplateService.DeleteNotificationTemplate(Guid.Empty);
            ...
            Assert.IsFalse(response.Notifications.HasErrors());
            Assert.IsInstanceOfType(response, typeof(GenericServiceResponse<bool>));
            mockRepository.Verify(x => x.Delete<NotificationTemplate>(Guid.Empty), Times.Once);
        }
        ...
        public void DeleteNotificationTemplateById_Service_Fail()
        {
            // Arrange
            notificationTemplateService = new NotificationTemplateService(mockRepository.Object, mockLogger.Object, mockCache.Object, mockTelemetry.Object);
            mockRepository.Setup(x => x.Delete<NotificationTemplate>(Guid.Empty)).Returns(false).Verifiable();
