...
namespace Domain.Services.Core
{
    public class OrganizationDepartmentService : ServiceBase, IOrganizationDepartmentService
    {
        ...
        public GenericServiceResponse<OrganizationDepartmentDto> FindOrganizationDepartmentById(Guid Id)
        {
        ...
        public GenericServiceResponse<bool> DeleteOrganizationDepartment(Guid Id)
        {
            return TryExecute<GenericServiceResponse<bool>>((response) =>
            {
