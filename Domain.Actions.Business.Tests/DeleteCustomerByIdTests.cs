...
{
    [TestClass]
    public class DeleteCustomerByIdTests
    {
        ...
        public void DeleteCustomerById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.CustomerService.DeleteCustomer(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteCustomerById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteCustomerById_Action_Fails()
        {
            // Arrange
