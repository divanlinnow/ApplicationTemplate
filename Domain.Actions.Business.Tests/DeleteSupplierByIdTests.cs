...
{
    [TestClass]
    public class DeleteSupplierByIdTests
    {
        ...
        public void DeleteSupplierById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.SupplierService.DeleteSupplier(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteSupplierById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteSupplierById_Action_Fails()
        {
            // Arrange
