...
{
    [TestClass]
    public class DeleteOrganizationBranchTests
    {
        ...
        public void DeleteOrganizationBranch_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.OrganizationBranchService.DeleteOrganizationBranch(branchDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteOrganizationBranch<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteOrganizationBranch_Action_Fails()
        {
            // Arrange
            var branchDto = TestHelper.OrganizationBranchDto();
