...
{
    [TestClass]
    public class DeleteOrganizationDepartmentTests
    {
        ...
        public void DeleteOrganizationDepartment_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.OrganizationDepartmentService.DeleteOrganizationDepartment(departmentDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteOrganizationDepartment<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteOrganizationDepartment_Action_Fails()
        {
            // Arrange
            var departmentDto = TestHelper.OrganizationDepartmentDto();
