...
{
    [TestClass]
    public class DeleteEmployeeByIdTests
    {
        ...
        public void DeleteEmployeeById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.EmployeeService.DeleteEmployee(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteEmployeeById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteEmployeeById_Action_Fails()
        {
            // Arrange
