...
{
    [TestClass]
    public class DeleteCurrencyTests
    {
        ...
        public void DeleteCurrency_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.CurrencyService.DeleteCurrency(currencyDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteCurrency<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteCurrency_Action_Fails()
        {
            // Arrange
            var currencyDto = TestHelper.CurrencyDto();
