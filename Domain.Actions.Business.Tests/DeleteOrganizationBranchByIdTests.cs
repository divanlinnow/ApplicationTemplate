...
{
    [TestClass]
    public class DeleteOrganizationBranchByIdTests
    {
        ...
        public void DeleteOrganizationBranchById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.OrganizationBranchService.DeleteOrganizationBranch(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteOrganizationBranchById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteOrganizationBranchById_Action_Fails()
        {
            // Arrange
