...
{
    [TestClass]
    public class DeleteOrganizationDepartmentByIdTests
    {
        ...
        public void DeleteOrganizationDepartmentById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.OrganizationDepartmentService.DeleteOrganizationDepartment(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteOrganizationDepartmentById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteOrganizationDepartmentById_Action_Fails()
        {
            // Arrange
