...
namespace Domain.Actions.Business.Tests
{
    ...
    public class GetAllOrdersTests
    {
        ...
        public void GetAllOrders_Action_Success()
        {
            // Arrange
            var fakeResponse = new GenericServiceResponse<IEnumerable<OrderDto>>
            {
                Result = TestHelper.OrderDtos()
            };
            ...
            Assert.IsTrue(result.Items.ToList().Count() == TestHelper.OrderDtos().Count());
        }
