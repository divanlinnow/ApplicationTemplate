...
namespace Domain.Actions.Business.Tests
{
    ...
    public class CreateOrderTests
    {
        ...
        public void CreateOrder_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.OrderService.CreateOrder(orderDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new CreateOrder<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void CreateOrder_Action_Fails()
        {
            // Arrange
            var orderDto = TestHelper.OrderDto();
