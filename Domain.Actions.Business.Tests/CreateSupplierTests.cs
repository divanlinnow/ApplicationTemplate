...
namespace Domain.Actions.Business.Tests
{
    ...
    public class CreateSupplierTests
    {
        ...
        public void CreateSupplier_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.SupplierService.CreateSupplier(supplierDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new CreateSupplier<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void CreateSupplier_Action_Fails()
        {
            // Arrange
            var supplierDto = TestHelper.SupplierDto();
