...
namespace Domain.Actions.Business.Tests
{
    ...
    public class DeleteProductByIdTests
    {
        ...
        public void DeleteProductById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.ProductService.DeleteProduct(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteProductById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteProductById_Action_Fails()
        {
            // Arrange
