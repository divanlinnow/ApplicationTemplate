...
namespace Domain.Actions.Business.Tests
{
    ...
    public class DeleteTaskByIdTests
    {
        ...
        public void DeleteTaskById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.TaskService.DeleteTask(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteTaskById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteTaskById_Action_Fails()
        {
            // Arrange
