...
namespace Domain.Actions.Business.Tests
{
    ...
    public class DeleteSupplierTests
    {
        ...
        public void DeleteSupplier_Action_Success()
        {
            // Arrange
            var supplierDto = TestHelper.SupplierDto();
            ...
            mockClientServicesProvider.Setup(x => x.SupplierService.DeleteSupplier(supplierDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteSupplier<GenericViewModel>(mockClientServicesProvider.Object)
            {
                OnComplete = model => viewModel = model
            };

            // Act
            var result = action.Invoke(supplierDto);
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteSupplier_Action_Fails()
        {
            // Arrange
            var supplierDto = TestHelper.SupplierDto();
