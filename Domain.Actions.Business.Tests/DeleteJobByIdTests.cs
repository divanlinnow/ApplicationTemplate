...
{
    [TestClass]
    public class DeleteJobByIdTests
    {
        ...
        public void DeleteJobById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.JobService.DeleteJob(It.IsAny<int>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteJobById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Business")]
        public void DeleteJobById_Action_Fails()
        {
            // Arrange
