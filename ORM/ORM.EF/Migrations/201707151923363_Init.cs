    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Province_ID = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        WorkflowProcess_ID = c.Guid(),
                        WorkflowProject_ID = c.Guid(),
                    })
                .PrimaryKey(t => t.ID)
                ...
                .ForeignKey("AppTemplate.WorkflowProcesses", t => t.WorkflowProcess_ID)
                .ForeignKey("AppTemplate.WorkflowProjects", t => t.WorkflowProject_ID)
                .Index(t => t.Branch_ID)
                .Index(t => t.Job_ID)
                .Index(t => t.Organization_ID)
                .Index(t => t.User_ID)
                .Index(t => t.Department_ID)
                .Index(t => t.WorkflowProcess_ID)
                .Index(t => t.WorkflowProject_ID);
        ...
        {
            DropForeignKey("AppTemplate.Tasks", "WorkflowProject_ID", "AppTemplate.WorkflowProjects");
            DropForeignKey("AppTemplate.WorkflowProjects", "ModifiedBy_ID", "AppTemplate.Users");
            DropForeignKey("AppTemplate.Employee", "WorkflowProject_ID", "AppTemplate.WorkflowProjects");
            DropForeignKey("AppTemplate.WorkflowProjects", "Department_ID", "AppTemplate.OrganizationDepartments");
            DropForeignKey("AppTemplate.WorkflowProjects", "CreatedBy_ID", "AppTemplate.Users");
            DropForeignKey("AppTemplate.Tasks", "WorkflowProcess_ID", "AppTemplate.WorkflowProcesses");
            DropForeignKey("AppTemplate.WorkflowProcesses", "ModifiedBy_ID", "AppTemplate.Users");
            DropForeignKey("AppTemplate.Employee", "WorkflowProcess_ID", "AppTemplate.WorkflowProcesses");
            ...
            DropIndex("AppTemplate.WorkflowProjects", new[] { "ModifiedBy_ID" });
            DropIndex("AppTemplate.WorkflowProjects", new[] { "Department_ID" });
            DropIndex("AppTemplate.WorkflowProjects", new[] { "CreatedBy_ID" });
            ...
            DropIndex("AppTemplate.Tasks", new[] { "WorkflowProject_ID" });
            DropIndex("AppTemplate.Tasks", new[] { "WorkflowProcess_ID" });
            ...
            DropIndex("AppTemplate.Employee", new[] { "WorkflowProject_ID" });
            DropIndex("AppTemplate.Employee", new[] { "WorkflowProcess_ID" });
            ...
            DropTable("AppTemplate.WorkflowProjects");
