...
namespace Domain.Actions.Core.Tests
{
    ...
    public class DeleteEmailTests
    {
        ...
        public void DeleteEmailTests_Action_Success()
        {
            ...
            mockClientServicesProvider.Setup(x => x.EmailService.DeleteEmail(emailDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteEmail<GenericViewModel>(mockClientServicesProvider.Object)
            {
