...
{
    [TestClass]
    public class DeleteEmailByIdTests
    {
        ...
        public void DeleteEmailById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.EmailService.DeleteEmail(It.IsAny<Guid>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteEmailById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void DeleteEmailById_Action_Fails()
        {
            // Arrange
