...
{
    [TestClass]
    public class CreateProvinceTests
    {
        ...
        public void CreateProvince_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.ProvinceService.CreateProvince(provinceDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new CreateProvince<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void CreateProvince_Action_Fails()
        {
            // Arrange
            var provinceDto = TestHelper.ProvinceDto();
