...
{
    [TestClass]
    public class CreateNotificationTemplateTests
    {
        ...
        public void CreateNotificationTemplate_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.NotificationTemplateService.CreateNotificationTemplate(notificationTemplateDto)).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new CreateNotificationTemplate<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void CreateNotificationTemplate_Action_Fails()
        {
            // Arrange
            var notificationTemplateDto = TestHelper.NotificationTemplateDto();
