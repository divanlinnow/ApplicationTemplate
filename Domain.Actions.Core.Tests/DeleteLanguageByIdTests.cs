...
{
    [TestClass]
    public class DeleteLanguageByIdTests
    {
        ...
        public void DeleteLanguageById_Action_Success()
        {
            // Arrange
            ...
            var action = new DeleteLanguageById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void DeleteLanguageById_Action_Fails()
        {
            // Arrange
