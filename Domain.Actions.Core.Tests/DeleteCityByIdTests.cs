...
{
    [TestClass]
    public class DeleteCityByIdTests
    {
        ...
        public void DeleteCityById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.CityService.DeleteCity(It.IsAny<Guid>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteCityById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void DeleteCityById_Action_Fails()
        {
            // Arrange
