...
{
    [TestClass]
    public class DeleteProvinceByIdTests
    {
        ...
        public void DeleteProvinceById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.ProvinceService.DeleteProvince(It.IsAny<Guid>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteProvinceById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void DeleteProvinceById_Action_Fails()
        {
            // Arrange
