...
{
    [TestClass]
    public class DeleteCountryByIdTests
    {
        ...
        public void DeleteCountryById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.CountryService.DeleteCountry(It.IsAny<Guid>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeleteCountryById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void DeleteCountryById_Action_Fails()
        {
            // Arrange
