...
{
    [TestClass]
    public class DeletePermissionByIdTests
    {
        ...
        public void DeletePermissionById_Action_Success()
        {
            // Arrange
            ...
            mockClientServicesProvider.Setup(x => x.PermissionService.DeletePermission(It.IsAny<Guid>())).Returns(fakeResponse).Verifiable();

            var viewModel = new GenericViewModel();

            var action = new DeletePermissionById<GenericViewModel>(mockClientServicesProvider.Object)
            {
        ...
        [TestMethod]
        [TestCategory("Actions - Core")]
        public void DeletePermissionById_Action_Fails()
        {
            // Arrange
