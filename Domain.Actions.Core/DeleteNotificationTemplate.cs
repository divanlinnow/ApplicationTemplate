...
namespace Domain.Actions.Core
{
    ...
    {
        public DeleteNotificationTemplate(IClientServicesProvider clientServices) : base(clientServices)
        {
        }
        ...
        public T Invoke(NotificationTemplateDto notificationTemplate)
        {
            return Execute(() =>
            {
                ...
                var serviceResult = ClientServices.NotificationTemplateService.DeleteNotificationTemplate(notificationTemplate);
